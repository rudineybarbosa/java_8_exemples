...
public class OptionalDemo2 {
    public static void main(String[] args) {
        ...
        Optional<Office> office1 = Optional.of(
                new Office("OF1", address1));

        Optional<Company> company1 = Optional.of(
                new Company("Door Never Closed", office1));
